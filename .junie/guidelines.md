These guidelines mirror AGENTS.md at the repository root. Both files exist because Junie reads .junie/guidelines.md while Claude Agent and other tools read AGENTS.md. Keep both files in sync.
